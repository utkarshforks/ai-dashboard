...
import { isValidAzureApiKey, ModelVendorAzureSearch } from './azsearch.vendor';


export function AzureSearchSourceSetup(props: { sourceId: DModelSourceId }) {

  // external state
  const { source, sourceHasLLMs, access, hasNoBackendCap: needsUserKey, updateSetup } =
    useSourceSetup(props.sourceId, ModelVendorAzureSearch);
